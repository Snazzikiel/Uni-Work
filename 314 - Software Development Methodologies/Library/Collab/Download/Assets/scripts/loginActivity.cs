...
public class loginActivity : MonoBehaviour {
	...
	void Start () {
		...
		//creating customers
		Customer customer1 = new Customer("harry","hazelton","h","p");
		Customer customer2 = new Customer("Connor","Jones","c","p");
        Customer customer3 = new Customer("David", "Azzi", "d", "a");
		...
		dictionaryCustomer.Add (customer3.getEmail (), customer3);



		Mechanic mechanic1 = new Mechanic("Steve","Harvey","s","p");
		Mechanic mechanic2 = new Mechanic("Aladin","Harvey","a","p");
		...
		activitymanager.getServiceRequest (0).customer = customer2;
