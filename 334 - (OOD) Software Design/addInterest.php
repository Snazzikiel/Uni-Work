...
<?php 
	...
	$sql = "";
	$allInterest = $objInterest->getTableData($sql);		
	...
	if($_SERVER["REQUEST_METHOD"] == "POST"){
		...
		//contactFirst
		$insert1 = $objInterest->insertTableData($arr);
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">ADD INTEREST</h1>
...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">	  
	...
	<?php
		...
		//get new CustomerID
		$newCustID = "";
		$newCustID = max(array_column($allInterest, 'CustomerID')) + 1;
		...
		foreach ($interestData as $row){
			foreach ($row as $field => $value){
					...
					if ($field == "CustomerID"){
						$tblData .= '<input size="50" name="' .$field .'" id="' . $field . '" type="text" value="'. $newCustID . '">';
